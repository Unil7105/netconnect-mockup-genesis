      ...
      <div className="max-w-7xl mx-auto px-4">
        <div className="flex justify-between items-center h-16">
            ...
            <div className="hidden md:ml-10 md:flex md:space-x-8">
              <Link
                ...
                className={`nav-link font-medium ${
                  isActive("/") ? "text-netconnect-blue dark:text-netconnect-mint" : ""
                }`}
              >
                Home
              </Link>
              <Link
                to="/network"
                className={`nav-link font-medium ${
                  isActive("/network") ? "text-netconnect-blue dark:text-netconnect-mint" : ""
                }`}
              >
                Network
              </Link>
              <Link
                to="/messages"
                className={`nav-link font-medium ${
                  isActive("/messages") ? "text-netconnect-blue dark:text-netconnect-mint" : ""
                }`}
              >
                Messages
              </Link>
          ...
          <div className="hidden md:flex items-center space-x-4">
            ...
            <Link to="/profile" className="p-0.5 rounded-full bg-gradient-to-r from-netconnect-blue to-netconnect-lilac">
              <img
      ...
      {isMenuOpen && (
        <div className="md:hidden bg-white dark:bg-netconnect-dark-card border-t border-gray-100 dark:border-gray-800">
          <div className="px-2 pt-2 pb-3 space-y-1">
            <Link
              to="/"
              className={`nav-link block px-3 py-2 rounded-md font-medium ${
                isActive("/") ? "text-netconnect-blue dark:text-netconnect-mint" : ""
              }`}
            >
              Home
